...
export class CommentsMigration1739463251163 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "tasks" ADD "status" character varying NOT NULL DEFAULT 'OPEN'`);
        await queryRunner.query(`ALTER TABLE "tasks" ADD "size" character varying NOT NULL DEFAULT 'S'`);
        await queryRunner.query(`ALTER TABLE "comment" ADD CONSTRAINT "FK_91256732111f039be6b212d96cd" FOREIGN KEY ("task_id") REFERENCES "tasks"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "comment" ADD CONSTRAINT "FK_f2ff23694f0736c3192d9aa4a7f" FOREIGN KEY ("owner_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "comment" DROP CONSTRAINT "FK_f2ff23694f0736c3192d9aa4a7f"`);
